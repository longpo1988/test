...
public class OBJRenderer extends RajawaliRenderer {
    ...
    protected void initScene() {
        ...
        mLight.setDirection(0, 0, -3);
        mLight.setPower(2.0f);
...
//        getCurrentScene().addLight(leftLight);
        ...
        getCurrentCamera().setPosition(0, 0, 90);
        getCurrentCamera().setLookAt(0, 0, 0);

        try {
            LoaderOBJ objParser = new LoaderOBJ(mContext.getResources(),
                    mTextureManager, R.raw.watch_panel_obj);
            objParser.parse();
            ...
            vMaterial.addTexture(new Texture("diffuse", R.drawable.v_suture_diffuse_map));
            vMaterial.addTexture(new SpecularMapTexture("earthSpecularTex", R.drawable.v_suture_specular_map));
...
//            smallMaterial.addTexture(new Texture("diffuse", R.drawable.small_diffuse_map));
////            smallMaterial.addTexture(new NormalMapTexture("small_normal", R.drawable.small_test_normal_map));
//            smallMaterial.addTexture(new SpecularMapTexture("earthSpecularTex", R.drawable.small_test_specular));
//            smallMaterial.setColorInfluence(0);
//
//            if (mObjectGroup.getChildByName("innerCircle0").getNumChildren() == 0) {
//                mObjectGroup.getChildByName("innerCircle0").setMaterial(smallMaterial);
//            } else {
//                mObjectGroup.getChildByName("innerCircle0").getChildAt(0).setMaterial(smallMaterial);
//            }
//
//            if (mObjectGroup.getChildByName("innerCircle1").getNumChildren() == 0) {
//                mObjectGroup.getChildByName("innerCircle1").setMaterial(smallMaterial);
//            } else {
//                mObjectGroup.getChildByName("innerCircle1").getChildAt(0).setMaterial(smallMaterial);
//            }
//
//            if (mObjectGroup.getChildByName("innerCircle2").getNumChildren() == 0) {
//                mObjectGroup.getChildByName("innerCircle2").setMaterial(smallMaterial);
//            } else {
//                mObjectGroup.getChildByName("innerCircle2").getChildAt(0).setMaterial(smallMaterial);
//            }
        ...
        mEmpty = new Object3D();
        TranslateAnimation3D anim = new TranslateAnimation3D(new Vector3(-0.3, -2.4, -3), new Vector3(0.3, 1.4, -3));
...
//        mObjectGroup.rotateAround(new Vector3(1,0,0), deltaTime * 60);
    ...
    private Vector3 mAccValues = new Vector3();
    
    public void setAccelerometerValues(float x, float y, float z) {
		mAccValues.setAll(y, x, -3);
	}
}
